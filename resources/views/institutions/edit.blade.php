...
<body>
    <x-layout-dashboard :usuario="$usuario">
        ...
        <div class="p-6">
            <div class="w-full max-w-3xl bg-white p-8 rounded-sm border-2 border-brand-gold shadow-md">
                <div class="mb-6 text-center">
                    <h1 class="text-2xl font-bold text-brand-green uppercase tracking-tighter">Editar Institución</h1>
                </div>
