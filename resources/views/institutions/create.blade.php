    ...
    <x-layout-dashboard :usuario="$usuario">
        ...
        <div class="p-6">
            <div class="max-w-3xl bg-white p-8 rounded-sm border-2 border-brand-gold shadow-md">
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-brand-green uppercase tracking-tighter">Registrar Nueva
                        Institución</h1>
                </div>
                ...
                <form action="{{ route('institutions.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div>
                                <label class="form-label-bold text-black">Nombre de la
                                    Institución</label>
                            ...
                            <div>
                                ...
                                <input type="text" name="telefono" class="form-input-pill border-2 border-brand-gold">
                            </div>
                        </div>

                        <div
                            class="flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-lg p-4 bg-gray-50">
                            <label class="form-label-bold text-black">Escudo /
                                Logo</label>

                            <div class="mb-3">
                                <img id="preview" src="https://via.placeholder.com/150?text=LOGO"
                            ...
                            <p class="text-[8px] text-gray-400 mt-2 uppercase">PNG, JPG o WEBP (Máx. 2MB)</p>
                        </div>
                    </div>
