    ...
    <x-layout-dashboard :usuario="$usuario">
        <x-page-header titulo="Programas">
            ...
            <div class="flex flex-col gap-2">
                ...
                <form action="{{ route('programs.index') }}" method="GET" class="flex items-center gap-3">
                    ...
                    <select name="estado" onchange="this.form.submit()"
                        ...
                        <option value="finalizado" {{ request('estado') == 'finalizado' ? 'selected' : '' }}>FINALIZADO
                        </option>
                    </select>
            ...
            <x-slot name="search">
                <form action="{{ route('programs.index') }}" method="GET" class="relative bg-white rounded-full">
        ...
        <div class="p-6">
            <div class="bg-white p-6 rounded-sm border-2 border-brand-gold shadow-md">
                ...
                <div class="grid grid-cols-1 gap-4 drop-shadow-md">
                    @forelse($cursos as $curso)
                                        <div class="border-2 border-brand-green rounded-sm drop-shadow-md">
                                            <div class="bg-white pl-4 pr-4 pt-4 flex items-center gap-4 hover:shadow-md transition-shadow">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="font-sans flex items-center gap-1 mt-0.5 italic">
                                                        @if($curso->docente)
                                                            {{ $curso->docente->nombre }} {{ $curso->docente->apellido_p }}
                                                            {{ $curso->docente->apellido_m }}
                                                        @else
                                                ...
                                                <div class="flex flex-col items-center gap-3 border-l border-gray-200 pl-4">
                                                    ...
                                                    @if(
                                                            ...
                                                            <div class="w-full flex justify-center mt-2 p-2">
                                                ...
                                                <div class="flex items-center gap-3 border-l border-gray-200 pl-4">
                                                    <div class="text-center">
                                                        <p
                                                            class="text-brand-green font-bold leading-none text-[11px] uppercase tracking-tighter mb-2">
                                                            Adicionales
                                                        </p>
                                                        <div class="flex justify-center items-center gap-2">
                                                            ...
                                                            @if(
                                                                ...
                                                                <a href="{{ route('modulo.create', ['id_curso' => $curso->id_curso]) }}"
                                                                    ...
                                                                    title="Añadir Clase">
                                                                    <div class="">
                                                                        <img src="/img/add_class.png" class="w-12 h-12 object-contain"
                                                                            alt="Añadir Clase">
                                                                    </div>

                                                                    <span
                                                                        class="absolute -top-8 scale-0 transition-all rounded bg-gray-800 p-1 text-[10px] text-white group-hover:scale-100">
                                                                        Añadir Módulo
                                                                    </span>
                                                                </a>
                                                                ...
                                                                <a href="{{ route('programs.edit', ['id' => $curso->id_curso]) }}"
                                                                    ...
                                                                    <span
                                                                        class="absolute -top-8 scale-0 transition-all rounded bg-gray-800 px-2 py-1 text-[10px] text-white group-hover:scale-100 whitespace-nowrap z-30">
                                                                        Editar Información
                                                                    </span>
                                                                </a>
                                                            @endif
                                                            ...
                                                            <div x-data="{ openModal: false }">
                                                                ...
                                                                <button @click="openModal = true"
                                                                    ...
                                                                    <img src="/img/add_student.png" class="w-12 h-12 object-contain"
                                                                        alt="Añadir Estudiante">
                                                                ...
                                                                <div x-show="openModal"
                                                                    ...
                                                                    <div class="bg-white w-[600px] max-h-[80vh] overflow-y-auto rounded-sm shadow-2xl"
                                                                        ...
                                                                        <h2
                                                                            class="font-sans font-bold mb-4 uppercase text-brand-green bg-brand-green text-white p-6">
                            ...
                            estudiantes: @js($allEstudiantes)
                                ...
                                ((e.ci ?? '').toLowerCase().includes(search.toLowerCase()))
                                                                                    ...
                                                                                    <div
                                                                                        class="flex justify-between items-center border p-2 rounded-sm">
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <div
                                                                                                class="font-sans text-brand-green text-left">
                                                                                                CI: <span x-text="est.ci"></span>
                                                                                            </div>
                                                                                        </div>

                                                                                        <form method="POST"
                                                                                            action="{{ route('curso.agregar.estudiante') }}">
                                                                                            @csrf
                                ...
                                (e.nombre + ' ' + e.apellido_p).toLowerCase().includes(search.toLowerCase()) ||
                                ((e.ci ?? '').toLowerCase().includes(search.toLowerCase()))
                            ).length === 0" class="text-center text-gray-400 text-xs py-4 italic">
                                                            ...
                                                            <a href="{{ route('curso.estudiantes', $curso->id_curso) }}"
                                                                ...
                                                                title="Añadir Clase">
                                                                <div class="">
                                                                    <img src="/img/watch_list.png" class="w-10 h-10 object-contain"
                                                                        alt="Añadir Clase">
                                                                </div>
                                                            ...
                                                            @if(
                                                                ...
                                                                <a href="{{ route('programs.payments.setup', $curso->id_curso) }}"
                                                                    ...
                                                                    title="Añadir Clase">
                                                                    <div class="">
                                                                        <img src="/img/plans_icon.png" class="w-10 h-10 object-contain"
                                                                            alt="Añadir Clase">
                                                                    </div>
                                                            ...
                                                            <div x-data="{ openEstudiantes: false }">
                                                                <button @click="openEstudiantes = true"
                                                                    ...
                                                                    <span
                                                                        class="absolute -top-8 scale-0 transition-all rounded bg-gray-800 px-2 py-1 text-[10px] text-white group-hover:scale-100 whitespace-nowrap z-50 shadow-lg font-sans">
                                                                        ...
                                                                        <div class="flex justify-between items-center bg-brand-green">
                                                                            <div class="flex items-center gap-2 p-2">
                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                    class="w-5 h-5 text-brand-green" fill="none"
                                                                                ...
                                                                                <h3
                                                                                    class="text-white font-sans font-semibold uppercase tracking-tighter">
                                                                            ...
                                                                            <button @click="openEstudiantes = false"
                                                                                class="text-white hover:text-red-600 transition-colors cursor-pointer p-6">
                                                                        ...
                                                                        <div class="p-5 bg-white overflow-y-auto max-h-[70vh]">
                                                                            <div class="" x-data="{ 
                                                                                ...
                                                                                <div class="text-center mb-8">
                                                                                    <p
                                                                                        class="text-[11px] font-sans font-bold tracking-widest mb-2 uppercase">
                                                                                        Formulario del curso</p>
                                                                                    <h4
                                                                                        class="text-lg font-sans font-bold text-black uppercase">
                                                                                        {{ $curso->nombre }}</h4>
                                                                                </div>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label
                                                                                        class="block uppercase font-sans font-bold text-brand-green mb-2">Copia
                                                                                        y envía el formulario al estudiante:</label>
                                                            ...
                                                            @if(
                                                                ...
                                                                <div x-data="{ openDelete: false }">
                                                                    <button @click="openDelete = true"
                                                                        ...
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            class="w-8 h-8 group-hover:text-red-600 transition-colors"
                                                                            fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                                            stroke-width="2">
                                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                        ...
                                                                        <div class="bg-white p-6 rounded-sm shadow-2xl w-80 text-left border-t-4 border-red-600 font-sans"
                                                                            ...
                                                                            <p class="text-[10px] mb-4 text-gray-600">
                                                                                ...
                                                                                <span class="text-black font-bold uppercase">
                                                                                    {{ $curso->nombre }} {{ $curso->apellido_p}}
                                                                                    {{ $curso->apellido_m}}
                                                                                </span>
                                                                            </p>

                                                                            <form action="{{ route('programs.destroy', $curso->id_curso) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
