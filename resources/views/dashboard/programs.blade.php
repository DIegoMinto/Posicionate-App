                        ...
                        <div class="border-2 border-brand-green rounded-sm shadow-sm">
                            ...
                            <div class="bg-white pl-4 pr-4 pt-4 flex items-center gap-4 hover:shadow-md transition-shadow">
                                ...
                                <div class="flex-shrink-0">
                                    ...
                                    @else
                                        <div class="w-20 h-20 bg-gray-100 flex items-center justify-center rounded-md border border-dashed border-gray-300">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="font-sans flex items-center gap-1 mt-0.5 italic">
                                        ...
                                        @else
                                            <span class="text-red-600">Sin designar</span>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    @if (in_array($usuario->cargo, ['supervisor_academico']) || $usuario->rol === 'super_admin')
                                        <div class="w-full flex justify-center mt-2 p-2">
                                            <form action="{{ route('programs.updateStatus', $curso->id_curso) }}" method="POST">
                                                ...
                                                @method('PATCH')
                                                <select name="estado" onchange="this.form.submit()"
                                                    class="w-24 text-[9px] font-bold uppercase py-1 px-2 rounded-sm border-2 transition-all cursor-pointer focus:ring-0 text-center
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="flex justify-center items-center gap-2">
                                            ...
                                            <a href="{{ route('programs.show', ['id' => $curso->id_curso]) }}"
                                                class="group relative flex items-center justify-center" title="Ver Detalles">
                                                <div class="pb-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-brand-green" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            ...
                                            @if (in_array($usuario->cargo, ['coordinador_academico', 'supervisor_academico', 'asistente_academico']) || $usuario->rol === 'super_admin')
                                                ...
                                                <a href="{{ route('modulo.create', ['id_curso' => $curso->id_curso]) }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 p-2 text-brand-green" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                                        ...
                                                        <circle cx="18.5" cy="5.5" r="4" fill="white" stroke="currentColor" stroke-width="1.5" />
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18.5 3.8v3.4M16.8 5.5h3.4" />
                                                    </svg>
                                                ...
                                                <a href="{{ route('programs.edit', ['id' => $curso->id_curso]) }}"
                                                    class="group relative flex items-center justify-center" title="Editar Curso">
                                            ...
                                            <a href="{{ route('curso.estudiantes', $curso->id_curso) }}"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 p-1.5 text-brand-green" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3-15H6a1.5 1.5 0 00-1.5 1.5v15A1.5 1.5 0 006 21h12a1.5 1.5 0 001.5-1.5V9L15 3z" />
                                            ...
                                            @if (in_array($usuario->cargo, ['supervisor_academico']) || $usuario->rol === 'super_admin')
                                                <a href="{{ route('programs.payments.setup', $curso->id_curso) }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 p-1.5 text-brand-green" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                                        ...
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 14.25h4.5" />
                                                    </svg>
                                                    <span class="absolute -top-8 scale-0 transition-all rounded bg-gray-800 p-1 text-[10px] text-white group-hover:scale-100">
                                                        Planes de Pago
                                                    </span>
                                            ...
                                            <div x-data="{ openEstudiantes: false }">
                                                ...
                                                <button @click="openEstudiantes = true"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-brand-green" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        ...
                                                        <div class="p-5 bg-white overflow-y-auto max-h-[70vh]">
                                                            <div x-data="{
                                                                ...
                                                                <div class="bg-gray-50 p-4 rounded-md border border-gray-200">
                                                                    <label class="block uppercase font-sans font-bold text-brand-green mb-2">
                                                                        Copia y envía el formulario al estudiante:
                                                                    </label>
                                            ...
                                            @if (in_array($usuario->cargo, ['supervisor_academico']) || $usuario->rol === 'super_admin')
                                                ...
                                                <div x-data="{ openDelete: false }">
                                                    ...
                                                    <button @click="openDelete = true" class="group relative flex items-center justify-center pb-1 cursor-pointer">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-brand-green group-hover:text-red-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <div class="flex items-center mt-2 px-4 mb-2">
                                ...
                                <div class="bg-brand-green text-white rounded-sm px-3 py-1 flex items-baseline gap-1.5 shadow-sm ml-20">
