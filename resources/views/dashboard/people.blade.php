        ...
        <x-page-header titulo="Todos los Estudiantes">
            ...
            @if($usuario->rol === 'super_admin')
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('people.export.excel', request()->query()) }}"
                        class="bg-green-700 text-white text-[10px] font-bold px-3 py-1.5 rounded-md hover:bg-green-800 transition">
                        Exportar Excel
                    </a>
                </div>
            @endif
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <thead>
                            <tr
                                ...
                                <th class="py-3 px-4 whitespace-nowrap">Curso</th>
                        ...
                        <tbody class="text-gray-700 text-[11px] font-medium">
                            @forelse($estudiantes as $index => $e)
                                ...
                                <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors text-black">
                                    ...
                                    {{-- 🟢 CURSO --}}
                                    <td class="py-3 px-4 whitespace-nowrap font-bold text-brand-green">
                                        {{ $e->curso_nombre }}
                                    </td>

                                    <td class="py-3 px-4 whitespace-nowrap">{{ $e->ci }}</td>
                                    ...
                                    <td class="px-4 text-right sticky right-0 bg-white">
                                        <div class="flex justify-center items-center gap-2">
                                            ...
                                            <a href="{{ route('estudiantes.edit', $e->id_estudiante) }}"
                                                class="text-blacks hover:text-brand-green transition">
                                            ...
                                            @if($e->estado != 'inscrito')
                                                <a href="{{ route('students.change', $e->id_estudiante) }}?id_curso={{ $e->id_curso }}"
                                                    class="group relative flex items-center justify-center hover:text-brand-green"
                                                    ...
                                                    <div x-show="openDelete"
                                                        ...
                                                        <div class="bg-white p-6 rounded-sm shadow-2xl w-80 text-left border-t-4 border-red-600 font-sans"
                                                            ...
                                                            <form action="{{ route('students.destroy', $e->id_estudiante) }}"
                                                                ...
                                                                <input type="hidden" name="id_curso" value="{{ $e->id_curso }}">
