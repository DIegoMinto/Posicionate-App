    ...
    <x-layout-dashboard :usuario="$usuario">
        ...
        <div class="p-6">
            <div class="max-w-2xl bg-white p-8 rounded-sm border-2 border-brand-gold shadow-md">
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-brand-green uppercase tracking-tighter">Registrar Nueva Sede</h1>
                </div>
                ...
                <form action="{{ route('sedes.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="pt-6 border-t border-gray-100 flex justify-end gap-3">
                        <a href="{{ route('sedes.index') }}" class=" font-sans uppercase py-3 px-6 hover:text-red-500">
                            Cancelar
                        </a>
